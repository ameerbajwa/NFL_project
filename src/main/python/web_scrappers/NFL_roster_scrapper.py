...
from src.main.python.cleaning_scrapped_data import cleaning_scrapped_roster_data
...
def grabbing_roster_info(list_of_active_teams):
    ...
    for active_team_index in range(0, len(list_of_active_teams)):
        ...
        cleaned_team_roster_df = cleaning_scrapped_roster_data.cleaning_NFL_roster_data(team_roster_df)
