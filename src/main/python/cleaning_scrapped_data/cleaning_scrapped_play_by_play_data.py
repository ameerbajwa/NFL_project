...
def determining_quarterback_or_rusher(play_details):
    words = play_details.split(' ')
...
def cleaning_play_by_play_info(play_by_play_df):
    ...
    play_by_play_df['quarterback'] = list(map(determining_quarterback_or_rusher, play_by_play_df['Detail']))
    play_by_play_df['rusher'] = list(map(determining_quarterback_or_rusher, play_by_play_df['Detail']))
